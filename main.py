...
def main():
    ...
    parser.add_argument('--url', default='https://github.com/Shahzebkhan123')
    ...
    qr_path = Path.cwd() / QR_DIRECTORY / qr_filename

    create_directory(Path.cwd() / QR_DIRECTORY)
    generate_qr_code(args.url, qr_path, FILL_COLOR, BACK_COLOR)
